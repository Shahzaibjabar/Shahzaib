...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .typing-wrapper .static { color: #cbd5e1; }
    ...
    .about-grid li span { font-weight:600; color:#e2e8f0; }
    ...
    .tool:hover img { filter:drop-shadow(0 6px 14px rgba(79,172,254,0.5)); }
    .tool span {
      margin-top:6px;
      color:#94a3b8;
      font-size:0.85rem;
    ...
    .stats-row img:hover { transform:scale(1.02); box-shadow:0 12px 36px rgba(79,172,254,0.2); }
    .stat-card { flex:1 1 260px; min-width:220px; }
    .lang-card { flex:1 1 200px; min-width:180px; }
    .divider {
      width:100%;
      height:2px;
